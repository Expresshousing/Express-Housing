  ...
  return (
    <div className="pb-20 pt-10" style={pageStyle(c)} data-testid="dashboard">
      <div className="eh-container">
        ...
        <h1 className="mt-6 max-w-4xl text-[46px] font-extrabold leading-[0.94] md:text-[68px]">Welcome back,<br />{user.name.split(" ")[0]}.</h1>
        <p className="mt-6 max-w-xl text-[15px] leading-relaxed md:text-[17px]" style={{ color: c.MUTED }}>Everything for your reservation, arrival, stay, and checkout—kept together and released when it’s ready.</p>
        ...
        {tab === "support" ? <SupportChat onClose={() => setSearchParams({})} /> : loading ? <div className="py-20 text-center"><div className="mx-auto h-10 w-10 animate-spin rounded-full border-4 border-t-transparent" style={{ borderColor: `${c.BLUE}33`, borderTopColor: c.BLUE }} /></div> : tab === "stays" ? (
